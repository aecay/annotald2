effect module ThirdParty.WindowEvents where { subscription = MySub } exposing (onWindow)

-- Source: https://github.com/Gizra/elm-keyboard-event/blob/1.0.0/examples/Window/Events.elm
